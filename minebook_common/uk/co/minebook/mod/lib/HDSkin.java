...
public final class HDSkin {

    private static HDSkin instance;
     ...
     * necessary.
     */
    public static HDSkin getInstance() {
        if (instance == null){
            instance = new HDSkin();
        }
        return instance;
    ...
    public void init(String parTxtUrl) {
        ...
        if (!instance.tickSetUp){
            ...
            TickRegistry.registerTickHandler(new HDSkinTickHandler(), Side.CLIENT);
